...
class JSONMigrations:
    ...
    def get_level_config(self, tool: str, volume: int) -> Optional[Dict[str, Any]]:
    ...
    def get_ruff_config(self, volume: int) -> Optional[str]:
    ...
    def get_pyright_config(self, volume: int) -> Optional[str]:
