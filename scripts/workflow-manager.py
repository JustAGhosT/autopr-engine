...
class WorkflowManager:
    ...
    def show_volume_system(self) -> None:
        ...
        print(
            "The workflow system uses volume levels (0-1000) to determine check intensity:\n"
        )
...
"""
        ...
        for name, config in self.WORKFLOWS.items():
            ...
            docs_content += (
                f"- **Volume Aware:** {'Yes' if config['volume_aware'] else 'No'}\n\n"
            )
...
def main():
    ...
    parser.add_argument(
        "command",
        choices=["list", "volume", "status", "validate", "stats", "docs"],
